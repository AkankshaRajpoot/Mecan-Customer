  ...
  Widget build(BuildContext context) {
    return (storeController.storeBanners != null && storeController.storeBanners!.isNotEmpty) ? Container(
      ...
      child: CarouselSlider.builder(
        key: ValueKey(storeController.storeBanners!.hashCode), // Add this line
        ...
        itemBuilder: (context, index, _) {
          return InkWell(
            ...
            child: ClipRRect(
              ...
              child: CustomImage(
                image: '${Get.find<SplashController>().configModel!.baseUrls!.bannerImageUrl}/${storeController.storeBanners![index].image}',
              ),
            ),
          );
        },
